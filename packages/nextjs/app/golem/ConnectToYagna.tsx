  ...
  return (
    <div className="card max-w-3xl">
      <div className="card-body">
        ...
        <h3 className="font-bold text-lg">1. Start yagna on your local machine</h3>
        <p>
          Make sure to include the flag <code>{`--api-allow-origin`}</code> with the url of this app:
        </p>
